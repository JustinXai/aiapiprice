...
export const pages: PageData[] = [
  ...
  },
  {
    ...
    updatedAt: '2026-06-03',
    internalLinks: ['/claude-fable-5-api-jiage/', '/claude-code-token-cost/', '/gemini-api-price/', '/openai-api-usage/', '/claude-code-token-cost/'],
    ctaEnabled: true,
    status: 'scaffold'
  },
  {
    slug: 'claude-fable-5-api-jiage',
    title: 'Claude Fable 5 API 价格：Input、Output、缓存和各平台费用',
    metaDescription: '查看 Claude Fable 5 API 价格，包括 input/output token、cache write/cache hit、AWS Bedrock、Google Vertex AI、Microsoft Foundry 和 OpenRouter 价格差异。',
    h1: 'Claude Fable 5 API 价格：Input、Output、缓存和各平台费用',
    category: 'model-price',
    targetKeywords: ['Claude Fable 5 API 价格', 'claude fable 5 api price', 'claude fable 5 价格', 'Claude Fable 5 token 价格', 'Claude Fable 5 input output price', 'Claude Fable 5 缓存价格', 'Claude Fable 5 cache hit', 'Claude Fable 5 Bedrock', 'Claude Fable 5 Vertex AI', 'Claude Fable 5 Foundry'],
    summary: '整理 Claude Fable 5 的 Anthropic 官方 API 价格，包括 input/output token、cache write/cache hit、Batch API 和不同平台（Bedrock、Vertex AI、Foundry、OpenRouter）的价格差异。',
    aiSummary: 'Claude Fable 5 API 价格页面整理 Anthropic Claude Fable 5 的官方 API 价格，包括 input $10/1M tokens、output $50/1M tokens、cache read $1/1M tokens、cache write $12.50/$20/1M tokens，以及 AWS Bedrock、Google Vertex AI、Microsoft Foundry 等平台的价格差异。Claude Fable 5 是 Anthropic 最高能力公开模型，上下文窗口 1M token，输出上限 128k，2026 年 6 月 9 日上线。价格和可用性可能变化，请以官方文档与后台记录为准。',
    faq: [
      { q: 'Claude Fable 5 API 价格是多少？', a: 'Claude Fable 5 官方 API 价格为 input $10/1M tokens，output $50/1M tokens。cache read $1/1M tokens，5 分钟 cache write $12.50/1M tokens，1 小时 cache write $20/1M tokens。具体费率请以 Anthropic 官方定价页为准。' },
      { q: 'Claude Fable 5 output 为什么更贵？', a: 'Claude Fable 5 的 output token 单价是 input 的 5 倍。Claude Code 等 coding agent 的 token 消耗通常是普通聊天的数倍到数十倍。具体倍数取决于代码库大小、上下文长度、工具调用频率和模型选择。建议先用小额请求测试，记录 usage 再估算成本。' },
      { q: 'Claude Fable 5 cache hit 是什么意思？', a: 'cache hit（即 cache read）指复用已缓存上下文时的费用，每百万 token 仅 $1，相比标准 input $10 有约 90% 折扣。cache write 是将上下文写入缓存的费用，5 分钟 TTL 为 $12.50/1M，1 小时 TTL 为 $20/1M。' },
      { q: 'Claude Fable 5 在 Bedrock 上价格一样吗？', a: 'AWS Bedrock 的 Claude Fable 5 input/output 价格与 Anthropic 官方一致（$10/$50/1M），但 Bedrock 按区域计费，缓存价格和 US-only 溢价政策可能有差异。具体请以 AWS Bedrock 定价页和后台账单为准。' },
      { q: 'Claude Fable 5 在 Vertex AI / Foundry 上怎么收费？', a: 'Google Vertex AI 和 Microsoft Foundry 的 Claude Fable 5 input/output 价格与官方一致（$10/$50/1M），按各平台计费体系结算，具体价格以对应云厂商定价页为准。' },
      { q: 'OpenRouter 的 Claude Fable 5 价格能当官方价格吗？', a: 'OpenRouter 上的 Claude Fable 5 价格仅为第三方参考，不代表 Anthropic 官方定价。OpenRouter 会叠加路由费用和手续费，实际消耗与官方价格可能有差异。' },
      { q: 'Claude Fable 5 适合 Claude Code 吗？', a: 'Claude Fable 5 适合复杂代码任务和长上下文 Agent 场景。但它的 output token 成本是 Opus 4.8 的 2 倍，是否适合取决于任务 token 消耗量和业务价值。建议先用小额请求测试并核对 usage，再决定是否扩大使用。' },
      { q: '国内用户怎么测试 Claude Fable 5 API 是否能用？', a: '建议先用 AI API Doctor 检测 Base URL、API Key 和模型名配置，再通过 LinkAI 注册入口小额测试。' },
    ],
    updatedAt: '2026-06-12',
    internalLinks: ['/claude-api-price/', '/claude-code-token-cost/', '/openrouter-yue/', '/api-koufei-yichang/', '/small-budget-api-test/'],
    ctaEnabled: true,
    status: 'full'
  },
  {
